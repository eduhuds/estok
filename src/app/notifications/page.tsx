    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Seus alertas e mensagens do sistema.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {notifications.length === 0 ? (
          ...
          notifications.map((notif) => (
            <div 
              key={notif.id} 
              className={`p-4 rounded-lg border ${!notif.readAt ? 'bg-indigo-50 border-indigo-100' : 'bg-white border-gray-200'}`}
            >
